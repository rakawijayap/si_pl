                ...
                <div class="table-responsive">
                 ...
                 $no = 1;
                  ...
                  <tr>
                    ...
                    <td><?php if($row['k']=='1'){echo "8-15%";} elseif ($row['k']=='0'){echo "0-8%";} elseif ($row['k']=='2'){echo "15-25%";} elseif ($row['k']=='3'){echo "25-40%";} else{echo ">40%";} {} ?> </td>
      ...
      <div class="modal-body">
        ...
        <table class="table borderless">
          ...
          <tr>
            ...
            <td width="3%">:</td>
            <td>
              <input type="number" name="k" class="form-control input-sm" style="color: black" value="<?php echo $rows['k']; ?>" required="" >
            </td>
          </tr>
         <?php   
