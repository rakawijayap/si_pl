              ...
              <div class="card-body">
                <div class="table-responsive">
                 ...
                 $i=1;
                  ...
                  <tr>
                    <td><?php echo $i++;?><?php  $row['id_kec']; ?></td>
                    ...
                    <td class="text-center" <?php if($rows['sebagai']=="user"){echo 'hidden="yes"';} else{} ;?>><?php }?>
                      <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#edit<?php echo $row['id_kec']; ?>"><i class="tim-icons icon-settings"></i></button>
                      <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#hapus<?php echo $row['id_kec']; ?>"><i class="tim-icons icon-trash-simple"></i></button>
                    </td>
      ...
      <?php   
   foreach ($list_kecamatan as $rows) {
?>
<div id="edit<?php echo $rows['id_kec']; ?>" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <table class="table borderless">
              ...
              <input type="hidden" name="id" class="form-control input-sm" value="<?php echo $rows['id_kec']; ?>" readonly>
...
<?php   
   foreach ($list_kecamatan as $rows) {
?>
<div id="hapus<?php echo $rows['id_kec']; ?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="id" value="<?php echo $rows['id_kec']; ?>">
      </div>
      <div class="modal-footer">
